...
function form($instance) {
	...
	echo cb_field($this->get_field_id('text'),aq_field_input('text',$block_id, htmlentities($text)),'Text','inp_larger','HTML allowed');
...
'ro'=>'rounded','content'=>'');
	...
	echo cb_field($this->get_field_id('heading'),aq_field_input('heading',$block_id, htmlentities($heading)),'Heading');
    ?>
    <input type="hidden" id="<?php echo $block_id ?>" name="aq_blocks[<?php echo $block_id; ?>][content]" value="<?php echo esc_attr($content); ?>">
    <div id="cb_edit_html_<?php echo $block_id; ?>" style="">
