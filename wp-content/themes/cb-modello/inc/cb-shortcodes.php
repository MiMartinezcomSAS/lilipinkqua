...
$woo.=' <section id="homepage-products-tab" class="section-products-grid">
                <div class="container"><div class="tab-nav-holder">
                        <ul class="nav-tabs">
                            <li class="active">
                                <a class="active-tab" href="#new" data-toggle="tab">'.__('New Products','cb-modello').'</a>
                            ...
                            <li>
                                ...
                                <div class="hover-holder">
                                    <ul>
                                        <li>
                                            <a class="tab-control" href="#bestsellers" data-toggle="tab">Best Sellers</a>
...
//LOADER END
	...
	$woo_sale='';
		if ( $products->have_posts() ) : ?>
	<?php $woo_sale.='<ul class="products prod_cat_'.$prod_rand; if($full_grid=='yes') $woo_sale.=' grid_view';$woo_sale.='" id="ul_hot_products"><li>';
	while ( $products->have_posts() ) : $products->the_post(); ?>
	<?php
	$name='product';
			$slug='content';
